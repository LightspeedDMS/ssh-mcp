...
describe('MCPSSHServer - Unit Tests', () => {
  ...
  describe('MCP Server Functionality', () => {
    ...
    it('should NOT have HTTP server capabilities', () => {
      expect(() => mcpServer.getWebPort()).toThrow('HTTP functionality not available');
      expect(() => mcpServer.isWebServerRunning()).toThrow('HTTP functionality not available');
    });
  ...
  describe('Port Coordination', () => {
    ...
    it('should throw error if web server port not set', () => {
      expect(() => mcpServer.getWebServerPort()).toThrow('Web server port not set by orchestrator');
    });
  });
